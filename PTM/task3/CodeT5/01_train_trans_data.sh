mkdir model
mkdir ./model/code_review2code_trans_data_task3/
mkdir ./model/code_review2code_trans_data_task3/cache/
mkdir ./model/code_review2code_trans_data_task3/outputs/
mkdir ./model/code_review2code_trans_data_task3/summary/
mkdir ./model/code_review2code_trans_data_task3/outputs/results
...
CUDA_VISIBLE_DEVICES=0 python  run_gen.py  --do_train --do_eval --do_eval_bleu  \
        ...
        --res_dir ./model/code_review2code_trans_data_task3/outputs/results \
        --res_fn  ./model/code_review2code_trans_data_task3/outputs/results/summarize_codet5_base.txt  \
